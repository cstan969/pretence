...
function GameDesignerChatWindow(props) {
  const {world_name} = props
  ...
  async function processMessage(messages) { // messages is an array of messages
    ...
    try {
      const response = await fetch('http://127.0.0.1:8003/message_game_designer_ai_and_get_response', {
          method: 'POST',
...
export default GameDesignerChatWindow