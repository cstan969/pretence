...
const SceneMusicFileSelector = ({ scene_id, defaultFileName }) => {
  ...
  const handleUpload = () => {
    ...
    if (selectedFile) {
      ...
      axios
        .post(`http://127.0.0.1:8002/set_scene_music_filepath?scene_id=${scene_id}`, formData)
        .then((res) => {
          console.log(res);
        })
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center' }}>
      <input ref={fileInputRef} type="file" style={{ visibility: 'hidden', position: 'absolute' }} onChange={handleMusicFileChange} />
...
export default SceneMusicFileSelector;