...
class NPC_Builder():
    ...
    def _prompt_create_character(self, npc_data=None):
        game_setting = 'The game is a grim hope style game'
        question = """I am creating a video game.  Can you create a JSON NPC character for me?  Fill in each value field. I want the character to be of the following format...
